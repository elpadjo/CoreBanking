...
public class AccountProfile : Profile
{
    public AccountProfile()
    {
        ...
        CreateMap<Account, AccountDetailsDto>()
            ...
            .ForMember(dest => dest.EnableTransactionAlerts, opt => opt.MapFrom(src => src.EnableTransactionAlerts))
            .ForMember(dest => dest.EnableLowBalanceAlerts, opt => opt.MapFrom(src => src.EnableLowBalanceAlerts))
            .ForMember(dest => dest.LowBalanceThreshold, opt => opt.MapFrom(src => src.LowBalanceThreshold))
            .ForMember(dest => dest.MonthlyStatementPreference, opt => opt.MapFrom(src => src.MonthlyStatementPreference))
        ...
        */
        ...
        CreateMap<CreateAccountRequest, CreateAccountCommand>()
            .ForMember(dest => dest.CustomerId, opt => opt.MapFrom(src => CustomerId.Create(src.CustomerId)))
            .ForMember(dest => dest.AccountType, opt => opt.MapFrom(src => src.AccountType))
            .ForMember(dest => dest.InitialDeposit, opt => opt.MapFrom(src => src.InitialDeposit))
