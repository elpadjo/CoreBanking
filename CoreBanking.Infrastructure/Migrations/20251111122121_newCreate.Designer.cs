...
namespace CoreBanking.Infrastructure.Migrations
{
    ...
    [Migration("20251111122121_newCreate")]
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateUpdated = new DateTime(2025, 10, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreditScore = 40,
                            DateCreated = new DateTime(2025, 10, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                            DateOfBirth = new DateTime(1995, 1, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            DateUpdated = new DateTime(2025, 10, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                            FirstName = "Alice",
                            IsActive = true,
                            IsDeleted = false,
