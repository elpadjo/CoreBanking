...
namespace CoreBanking.Infrastructure.Migrations
{
    ...
    [Migration("20251114210801_NewAccountColsForPreferences")]
    partial class NewAccountColsForPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.Property<bool>("EnableLowBalanceAlerts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("EnableTransactionAlerts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<string>("MonthlyStatementPreference")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.OwnsOne("CoreBanking.Core.ValueObjects.Money", "LowBalanceThreshold", b1 =>
                        {
                            b1.Property<Guid>("AccountId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.Navigation("LowBalanceThreshold");
                });
