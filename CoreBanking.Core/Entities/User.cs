...
namespace CoreBanking.Core.Entities
{
    public class User : Entity<UserId>
    {
        ...
        public static User CreateTeller(string username, string passwordHash)
        {
            return new User(username, passwordHash, UserRole.Teller);
        }

        public static User CreateManager(string username, string passwordHash)
        {
            return new User(username, passwordHash, UserRole.Manager);
        }
